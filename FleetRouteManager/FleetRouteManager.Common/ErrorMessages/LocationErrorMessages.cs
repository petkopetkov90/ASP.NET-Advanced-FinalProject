namespace FleetRouteManager.Common.ErrorMessages
{
    public static class LocationErrorMessages
    {
        ...
        public const string LocationPhoneNumberFormatMsg = "Phone number must contain only digits (0-9) and may optionaly start with a \"+\".<br>It may optionally contain spaces ( ) between groups of digits, but only one space is allowed in a row.";
